...
var APP_CHANGELOG = [
  { ver: '2.6.0', date: '29.03.2026', items: [
    ...
    '⚡ Устранено мигание страницы при первом открытии (тема теперь применяется до рендера)',
    '🚶 Демо: добавлен пешеходный день по Каппадокии — Ургюп → Ортахисар → Долина Голубятен → Гёреме'
  ]},
