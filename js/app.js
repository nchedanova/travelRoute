...
var APP_CHANGELOG = [
  { ver: '2.8.0 b8', date: '10.04.2026', items: [
    '🖼 Фото в чате: качество JPEG повышено (0.85 вместо 0.7), разрешение до 1600px',
    '📍 Убрана подсказка для типа «Другое» — только Заправка, Кафе, Магазин',
    '↕ Форма добавления точки: больше отступа сверху',
    '🚗 Название старта: font-size 11px'
  ]},
